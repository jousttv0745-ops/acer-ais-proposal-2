...
(() => {
  ...
  window.SPEC = {
    ...
    l1: [
      ...
      { id: 'L1-5', seg: 'FAQ', ref: { page: 'samsung', region: 'faq', label: 'Samsung · FAQ' },
        goal: '集中處理免責與長尾問題，兼顧 SEO',
        material: '文字手風琴',
        ratio: '單欄；預設收合',
        scope: '5–8 題：支援機型（取代相容清單）、語言、下載與費用、Qubi 是什麼、資料怎麼處理',
        asset: 'FAQ 文案＋註腳',
        story: '用讀者會問的句子當題目' },
    ],
    ...
    wireframe: {
      ...
      segments: [
        ...
        { id: 'L1-5', h: 950, boxes: [
          ...
          { k: 'asset', a: 'A07', x: 270, y: 170, w: 900, h: 590 },
    ...
    assets: [
      ...
      { no: 'A07', name: 'FAQ 文案', seg: 'L1-5', file: 'faq.docx', spec: 'FAQ 5–8 題＋註腳', qty: '1', owner: 'PM／法務', status: '待提供' },
    ],
  };
})();